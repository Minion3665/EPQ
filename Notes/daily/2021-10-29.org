...
0:17:03 [[https://calendar.google.com/calendar/embed?src=qgbb951tlmrgd0sm3nl1f9e67c%40group.calendar.google.com&ctz=Europe%2FLondon][Here's a link to the calendar]]. Google took a while to create it, so while it was creating it I fixed the css for the header (making it wrap on smaller screens), next I'm going to create a kanban board using github projects (quire is nice, but using the same website for everything is nicer)
...
0:28:40 I've ended the timer for now, I'll likely be returning to do more work later under a different timer. When I do, I'll probably be working on the [[id:8ee72434-d01f-46c9-a903-09ee8a03439c][Docker vs LXC]] series of notes that I haven't yet finished writing up.
